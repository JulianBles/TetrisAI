...
class Tetris(Env):
    ...
    def calculate_best_move(self):
        ...
        # TODO: Check all spots and calculate best option
        # Start top left and check all rotations
...
while not done:
    ...
    if counter % (fps // game.level // 2) == 0 or pressing_down:
        if game.state == "start":
            if action_list == []:
                action_list = game.calculate_best_move()

            # TODO: Perform action from action list
